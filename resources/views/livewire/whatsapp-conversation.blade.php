<div>
    ...
    <!-- Modal toggle -->
    <button data-modal-target="default-modal-{{ $step->id }}" data-modal-toggle="default-modal-{{ $step->id }}"
        class="border rounded-full btn border-success text-success hover:bg-success hover:text-white" type="button">
        Ver conversación
    </button>

    <!-- Main modal -->
    <div id="default-modal-{{ $step->id }}" tabindex="-1" aria-hidden="true"
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="flex items-center justify-between p-4 border-b rounded-t md:p-5 dark:border-gray-600">
                    ...
                    <button type="button"
                        ...
                        data-modal-hide="default-modal-{{ $step->id }}">
                            ...
                            @foreach ($messages as $message)
                                ...
                                @if ($message->type == 'enviado')
                                    <div class="flex justify-end">
                                        <div
                                            class="flex flex-col w-11/12  leading-1.5 p-4 border-gray-200 bg-gray-100 rounded-xl dark:bg-gray-700">
                ...
                <div class="flex items-center p-4 border-t border-gray-200 rounded-b md:p-5 dark:border-gray-600">
                    <button data-modal-hide="default-modal-{{ $step->id }}" type="button"
