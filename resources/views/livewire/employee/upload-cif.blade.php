<div>
    ...
    <div class="w-full h-full mt-5 fixed top-0 left-0 z-50 transition-all duration-500 fc-modal hidden">
        <div
            ...
            <form action="{{ route('admin.check_rfc', $employee->id) }}" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <div class="px-4 py-8">
                    <div class="grid lg:grid-cols-2 grid-cols-1 gap-6 my-2">
                        ...
                        <div>
                            <label for="simpleinput"
                                class="text-gray-800 text-sm font-medium inline-block mb-2">id CIF</label>
                                <p class="text-xs">
                    ...
                    <div class="flex justify-end items-center gap-4 p-4 border-t">
                        <button
                            class="btn border border-slate-200  hover:bg-slate-100 transition-all"
                            data-fc-dismiss type="button">
                            Cerrar
                        </button>
