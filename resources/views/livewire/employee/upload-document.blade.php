    ...
    <div id="modalDocument"
        ...
        <div
            ...
            <div class="px-4 py-8 flex">
                <form action="{{ route('admin.uploadDocument', $employee->id) }}" method="post"
            ...
            <div class="flex justify-end items-center gap-4 p-4 border-t ">
                <button class="btn  border border-slate-200 hover:bg-slate-100  transition-all"
                ...
                @livewire('employee.upload-cif', ['employee' => $employee])
            </div>
        </div>
    </div>
</div>
